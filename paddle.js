...
if (collision(ball,player) && user.score === 3){
winmsg.innerText = "YOU WON!"
winmsg.classList.add("winningmsg")
resetGame()
restartGame()
}else if(collision(ball,player) && com.score === 3){
...
// function init(){
//     document.querySelector('.reset-buttons').addEventListener('click', function(event){
